...
const AboutUs = () => {
  return (
    <section>
        <div className=' w-full h-159.5 bg-grayBg mt-11 px-40'>
            <div className='flex'>
                <div className=' w-[50%] h-159.5'>
                    <div className='w-[499px] mx-auto pt-[155px] text-left items-center'>
                        ...
                        <button className='w-[162px] h-[52px] px-[22px] py-2.5 border-[1.8px] border-black222'><a className=' text-black222 text-[16px] leading-[23px] font-medium ' href="#">EXPLORE MORE</a></button>
                    </div>
                </div>
                <div>
